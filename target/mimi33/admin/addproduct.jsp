...
<html>
    ...
    <script type="text/javascript">
        function fileChange(){
        	...
        	$.ajaxFileUpload({
				url:"${pageContext.request.contextPath}/prod/ajaxImgUpload.action",
				secureuri:false,
				fileElementId:"pimage",
				dataType:"json",
				success:function (obj){
					$("#imgDiv").empty()
					alert("${pageContext.request.contextPath}/image_big/"+obj.filename)
					var img=$("<img/>")
					img.attr("src","${pageContext.request.contextPath}/image_big/"+obj.filename)
	...
	<!--取出上一个页面上带来的page的值-->
		...
		<div id="addAll">
			...
			<div id="table">
				<form  id="myform" action="${pageContext.request.contextPath}/prod/saveProduct.action">
					<table>
						<tr>
